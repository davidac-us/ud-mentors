    ...
    <div className="px-5 pb-6 pt-6">
          ...
          <DialogContent>
            ...
            <div className="space-y-4">
              <div className="flex gap-2">
                ...
                <Button
                  type="button"
                  variant={kind === 'club' ? 'default' : 'outline'}
              ...
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  maxLength={120}
                  placeholder="Trabant University Center"
                />
              </div>
              {kind === 'event' && (
                <div className="space-y-1.5">
      ...
      <div className="mb-5 inline-flex rounded-full bg-muted p-1">
        <button
          ...
          className={`rounded-full px-5 py-1.5 text-sm font-medium transition ${
            filter === 'event' ? 'bg-card shadow-sm text-foreground' : 'text-muted-foreground'
          }`}
        >
          Events
        </button>
        <button
          ...
          className={`rounded-full px-5 py-1.5 text-sm font-medium transition ${
            filter === 'club' ? 'bg-card shadow-sm text-foreground' : 'text-muted-foreground'
          }`}
        >
          Clubs
        </button>
      ...
      {filtered.length === 0 ? (
        <EmptyState
          ...
          title={filter === 'event' ? 'No events yet' : 'No clubs yet'}
